...
import { data, Best, TopProduct } from "../Home/Tabs/Data";
import SweetPagination from "sweetpagination";
import axios from "axios";
import { useEffect, useState } from "react";
function Shop() {
  const allProducts = [...data, ...Best, ...TopProduct];
  ...
  const fetchProducts = async () => {
    await axios.get("http://localhost:3002/products").then((response) => {
      ...
      const mappedFetchedProducts = fetchedProducts.map((fetchedProduct) => {
        return {
          ...fetchedProduct,
      ...
      const combinedProducts = [...product, ...mappedFetchedProducts];
  ...
  useEffect(() => {
    ...
    const newPageData = product.slice(newStartIndex, newEndIndex);
    setCurrentPageData(newPageData);
  }, [currentPage, productsPerPage, product]);
  ...
  return (
    <>
      <div className="container shop">
        ...
        >
          <div className="shoppy_conatiner">
            <div className="shoppy_row">
              <div className="shoppy_col">
                <p className="mt-3">Showing 1–2 of 2 results</p>
              </div>
              <div className="shoppy_col">
                ...
                <div className="top_col" key={item.id}>
                  ...
                  <div className="buttons-container">
                    ...
                    <OverlayTrigger
                      ...
                      delay={{ show: 250, hide: 400 }}
                      overlay={
                        <Tooltip id="add-tooltip">Add to WishList</Tooltip>
                      }
                    >
