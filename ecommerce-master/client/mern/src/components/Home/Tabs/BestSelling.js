            ...
            Best.map((item) => (
              <div className="top_col" key={item.id}>
                ...
                <OverlayTrigger
                    ...
                    overlay={<Tooltip id="like-tooltip">Product Details</Tooltip>}
                  >
    <button className="action-button comment-button shadow" data-toggle="tooltip" data-placement="left" title="Tooltip on left">
    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="25" fill="currentColor" class="bi bi-link-45deg" viewBox="0 0 16 16">
